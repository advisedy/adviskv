...
- `read_ratio=0.0` 时，`success_qps` 约 8919。
- `read_ratio=0.8` 时，`success_qps` 约 8230，这是本报告建议作为 mixed 默认读多写少场景引用的点。
- `read_ratio=1.0` 时，`success_qps` 约 11130。
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 0.00 | 0% | 100% | 8919.35 | 1792.54 | 1558 | 3062 | 6831 | 0 |
| 0.50 | 50% | 50% | 8936.63 | 1789.31 | 1496 | 3605 | 5788 | 0 |
| 0.80 | 80% | 20% | 8229.54 | 1942.99 | 1740 | 3358 | 4474 | 0 |
| 0.95 | 95% | 5% | 9475.77 | 1687.23 | 1560 | 2719 | 3543 | 0 |
| 1.00 | 100% | 0% | 11130.39 | 1436.45 | 1398 | 1922 | 2312 | 0 |
