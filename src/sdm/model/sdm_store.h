...
public:
    ...
    Status del_shard_route_entry(TableID table_id, ShardID shard_id, const ReplicaKey& replica_key );
    ...
    Status list_replicas_by_shard(TableID table_id, ShardID shard_id, std::vector<ReplicaPtr>& out) const; 
